...
void main(){
   ...
   int pin=2023,option,entered_pin,count=0,amount=1;//functions are defined here
   ...
   switch(option){
     ...
     case 1:
            ...
            break;
             ...
             printf("\n\t\tYou have withdraw .%d. MKD Your new balance is %.2f",amount,balance);
     ...
     case 2:
            ...
            printf("\n\t\tYou have deposited .%d. MKD Your new balance is %2f",amount,balance);
     ...
     case 3:
            ...
            printf("\n\t\t Your balance is .%.2f MKD",balance);
